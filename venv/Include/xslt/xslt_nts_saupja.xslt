                        ...
                        <tr>
                            <td style="border:solid 2px #000000;">
                                <table frame="void" border="1" class="table_input" width="100%" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td class="sub">bcNm</td>
                                        <td class="data"><xsl:value-of select="root/bmanBscInfrInqrDVO/bcNm"/></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="sub">itmNm</td>
                                        <td class="data"><xsl:value-of select="root/bmanBscInfrInqrDVO/itmNm"/></td>
                                        <td class="sub"></td>
                                        <td class="data"></td>
                                    </tr>
