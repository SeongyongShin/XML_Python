                        ...
                        <tr>
                            <td style="border:solid 2px #000000;">
                                <table frame="void" border="1" class="table_input" width="100%" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td class="sub">상태</td>
                                        <td class="sub">개업일자</td>
                                        <td class="sub">상호</td>
                                        <td class="sub">사업자번호</td>
                                    </tr>

                                    <xsl:for-each select="list/map">
                                        <tr>
                                            <td class="sub"><xsl:value-of select="txprStatNm"/></td>
                                            <td class="sub"><xsl:value-of select="txprDscmDt"/></td>
                                            <td class="sub"><xsl:value-of select="txprNm"/></td>
                                            <td class="sub"><xsl:value-of select="txprDscmNoEncCntn"/></td>
                                        </tr>
                                    </xsl:for-each>
                                </table>
                            </td>
