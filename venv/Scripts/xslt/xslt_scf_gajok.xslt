                            ...
                            <td style="border:solid 2px #000000;">
                                <table frame="void" border="1" class="table_input" width="100%" cellspacing="0" cellpadding="0">
                                    ...
                                    <xsl:for-each select="docuInfo/family/*">
                                        <tr>
                                            <td class="data"><xsl:value-of select="*/rel"/></td>
                                            <td class="data"><xsl:value-of select="*/name"/></td>
                                            <td class="data"><xsl:value-of select="*/born_date"/></td>
                                            <td class="data"><xsl:value-of select="*/rrn"/></td>
                                            <td class="data"><xsl:value-of select="*/gen"/></td>
                                            <td class="data"><xsl:value-of select="*/bon"/></td>
                                        </tr>
                                    </xsl:for-each>
                                </table>
                            </td>
